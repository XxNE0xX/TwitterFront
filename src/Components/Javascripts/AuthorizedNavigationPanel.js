        ...
        return (
            <div className="NavigationContainer">
                <div className={"buttons-container"}>
                    ...
                    <Button size={"large"} onClick={this.profileButtonHandler} className={"NavigationButton"}
                            shape={"round"}>
                        <Icon text={"Profile"}/>
                    </Button>
                </div>
                ...
                <div className={"tweet-text-area-container"}>
                    <TextArea value={value} onChange={this.onChange} placeholder={"Say what is in your mind!"}
                              autoSize={{minRows: 5, maxRows: 5}} showCount maxLength={250}/>
                </div>
                ...
                <Button onClick={this.editProfilePageHandler} className={"NavigationButton"} shape={"round"}
